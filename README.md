...
# SBC. × SDGs × 超未来志向
   ...
   ます。近い将来、広域宇宙及び特定の惑星に一般市民が移住することやVRないしムーンショット計画（2050年,内閣府）における第三の空間にまで人類が入ることを想定し、次の開発目標ではそれらの空間への適用を見据えています。
...
Code for HodogayaにおいてVR空間を複数開発し、クライアントに提供しています。活用方法としてはイベントや会議など、既存サービスとは異なる新しいスタイルを提案しています。
