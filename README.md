...
[^オープンデータ]: オープンデータとは、条件を満たし、定義された特定のデータが、自由に使用でき、かつ様々な利活用される可能性を前提に公開される考え方や仕組みのことです。また、クリエイティブ・コモンズ・ライセンスを定めることによって使用範囲を明確化します。
